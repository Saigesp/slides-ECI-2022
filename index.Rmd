...
Disciplina encargada del estudio, la recolección, la organización, el análisis, la interpretación y **la presentación** de los datos.
...
✖️ La **espiral es una forma geométrica compleja**: la original, no estar ni centrada ni concéntrica, distorsiona el crecimiento de los casos y su estacionalidad.
...
* Distorsión mínima posible de la realidad

```{r echo = FALSE, out.width = "55%", fig.align = "center", fig.cap = "Infografía extraída de https://twitter.com/storywithdata"}
...
Una **buena idea** puede estar mejor o peor ejecutada, y la forma de llevaro a cabo es importante
...
## **Práctica evaluable II: primeras visualizaciones**
