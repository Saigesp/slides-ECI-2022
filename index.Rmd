...
```{r dplyr, echo = FALSE,  out.width = "60%", fig.align = "center", fig.cap = "3heet sheet de las opciones del paquete dplyr para la manipulación de datos extraída de https://github.com/rstudio/cheatsheets/blob/master/data-transformation.pdf"}
