...
Impartido por Javier Álvarez Liébana y Gabriel Valverde Castilla.

* Instalación de R y RStudio.
* Primeros pasos como calculadora 
* Tipos de datos (individuales)
* Vectores
* Operaciones con vectores
* Datos estructurados: matrices y data.frame
* Primer análisis de datos: arrestos en Estados Unidos
* Extras: estructuras de control, proyectos, funciones y tibble

* Caso práctico: crear un Rmarkdown (35 minutos; acumulado 5 horas) [¿AMBOS?]
* Evaluación
...
## BLOQUE III. Periodismo de datos: análisis electoral y visualización en R

Impartido por Borja Andrino, Javier Álvarez Liébana y Gabriel Valverde Castilla.

## BLOQUE IV. Story Telling: lo que nos cuentan los datos

Impartido por Victòria Oliveres, Javier Álvarez Liébana y Gabriel Valverde Castilla.

## BLOQUE V. Visualización de datos en mapas en R
...
### [Celdas: tipos de datos](#matrices)

### [Columnas: vectores](#matrices)

### [Tablas: estructuras de datos](#datos)
...
# ¿Qué es R? Primeros pasos
## **Instalación**

&nbsp;

Programar es como escribir un libro: necesitamos una gramática y un Word.
